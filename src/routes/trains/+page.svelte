<script lang="ts">
    ...
    const step2Data: Step2Data = {
        "0": {
            stepTitle: "Выберите год обучения",
            options: [
                {
                    id: "0",
                    name: "ОФПФ (5-6 лет)",
    ...
    const step3Data: Step3Data = {
        ...
        "1": {
            stepTitle: "Выберите блок начальной подготовки 1-го года обучения",
            options: [
                { id: "0", name: "Блок 1 Техника передвижения", title: "" },
        ...
        "2": {
            stepTitle: "Выберите блок начальной подготовки 2-го года обучения",
            options: [
        ...
        "3": {
            stepTitle: "Выберите блок начальной подготовки 3-го года обучения",
            options: [
